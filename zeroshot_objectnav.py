...
def main():
    ...
    def configure_lm(lm):
        ...
        if lm == "BERT":
            ...
            # raise NotImplemented
            lm_model = GPT2LMHeadModel.from_pretrained("/home/lingfeng/HuggingFace-Download-Accelerator-main/models--openai-community--gpt2-large")
            tokenizer = GPT2Tokenizer.from_pretrained("/home/lingfeng/HuggingFace-Download-Accelerator-main/models--openai-community--gpt2-large")
            # object_norm_inv_perplexity = compute_object_norm_inv_ppl(
